//  Tool to calculate monolingual word-word cooccurrence statistics
//
...
int verbose = 2, lan1 = 1, lan2 = 1; // 0, 1, or 2
...
int main(int argc, char **argv) {
    ...
    if (argc == 1) {
        printf("Tool to calculate monolingual word-word cooccurrence statistics\n");
        ...
        printf("\t-lan <int>\n");
        printf("\t\tSet language id (default is 1)\n");
    ...
    if ((i = find_arg((char *)"-lan", argc, argv)) > 0) lan1 = atoi(argv[i + 1]);
    lan2 = lan1;
